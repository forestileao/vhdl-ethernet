...
SOURCES = [
    ...
    "src/ptp/ptp_clock.vhd",
    "src/ptp/ptp_clock_cdc.vhd",
    "src/ptp/ptp_perout.vhd",
    "src/ptp/ptp_timestamp_capture.vhd",
    "src/ptp/ptp_tag_tracker.vhd",
    "src/ptp/ptp_tod_split.vhd",
    "src/ptp/ptp_ts_extract.vhd",
    "src/ptp/ptp_td_leaf.vhd",
    "src/ptp/ptp_td_phc.vhd",
    ...
    "src/axis/axis_byte_ram_switch2.vhd",
    "src/axis/axis_byte_cobs_encoder.vhd",
    "src/axis/axis_byte_cobs_decoder.vhd",
    "src/axis/axis64_to_byte_stream.vhd",
    "src/axis/byte_stream_to_axis64.vhd",
    ...
    "src/stream/ether_fcs_append64.vhd",
    "src/stream/ether_fcs_strip64.vhd",
    ...
    "src/mac/axis_xgmii_tx64.vhd",
    "src/mac/axis_xgmii_rx64.vhd",
    "src/mac/ether_mac_10g.vhd",
    "src/mac/axis_xgmii_tx32.vhd",
    "src/mac/axis_xgmii_rx32.vhd",
    "src/mac/ether_mac_10g32.vhd",
    "src/phy/baser_encode64.vhd",
    "src/phy/baser_decode64.vhd",
    "src/phy/eth_phy_10g.vhd",
    "src/phy/eth_mac_phy_10g.vhd",
    "src/mac/gmii_phy_if.vhd",
    "src/mac/mii_phy_if.vhd",
    "src/mac/rgmii_phy_if.vhd",
    ...
    "src/layers/ether_ipv4_tx64.vhd",
    "src/layers/ether_ipv4_rx64.vhd",
    "src/layers/ether_ipv4_stack64.vhd",
    ...
    "src/layers/ether_udp_tx64.vhd",
    "src/layers/ether_udp_rx64.vhd",
    "src/layers/ether_udp_checksum_gen64.vhd",
    "src/layers/ether_udp_stack64.vhd",
    "src/layers/ether_udp_ipv4_complete64.vhd",
]
