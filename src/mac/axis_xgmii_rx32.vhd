...
entity axis_xgmii_rx32 is
    ...
    port (
        clk             : in  std_logic;
        rst             : in  std_logic;
        xgmii_rxd       : in  word32_t;
        xgmii_rxc       : in  keep4_t;
...
architecture rtl of axis_xgmii_rx32 is
                ...
                case state is
                    when IDLE =>
                        ...
                        for lane in 0 to 3 loop
                            if xgmii_rxc(lane) = '1' and lane_byte32(xgmii_rxd, lane) = x"FB" then
                                state <= COLLECT;
                                skip_count <= 4;
                            end if;
                        end loop;
