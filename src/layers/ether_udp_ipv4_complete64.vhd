...
architecture rtl of udp_ipv4_complete64 is
    signal udp_data : word64_t;
    signal udp_keep : keep8_t;
    signal udp_valid : std_logic;
    signal udp_ready : std_logic;
    signal udp_last : std_logic;
    signal udp_user : std_logic;

    signal ip_payload_data : word64_t;
    signal ip_payload_keep : keep8_t;
...
begin
    ...
    udp_encoder: entity work.udp_tx64
        port map (
            clk => clk, rst => rst,
    ...
    ip_encoder: entity work.ipv4_tx64
        port map (
            clk => clk, rst => rst,
            s_hdr_valid => tx_hdr_valid,
    ...
    ip_decoder: entity work.ipv4_rx64
        port map (
            clk => clk, rst => rst,
            s_axis_tdata => rx_ip_tdata,
            s_axis_tkeep => rx_ip_tkeep,
            ...
            m_axis_payload_tkeep => ip_payload_keep,
    ...
    udp_decoder: entity work.udp_rx64
        port map (
            clk => clk, rst => rst,
            s_axis_tdata => ip_payload_data,
            s_axis_tkeep => ip_payload_keep,
